...
async function run() {
  ...
  try {
    ...
    await page.goto('https://rimec-web.vercel.app/login');
    ...
    await page.screenshot({ path: 'C:\\Users\\hecto\\.gemini\\antigravity\\brain\\1c2fd88a-fd50-455c-9041-7be61d1bc324\\before_submit.png' });
    ...
    try {
      ...
      try {
        ...
        console.error('Failed to get page content:', htmlErr.message);
      }
      ...
      await page.screenshot({ path: 'C:\\Users\\hecto\\.gemini\\antigravity\\brain\\1c2fd88a-fd50-455c-9041-7be61d1bc324\\login_failure.png' });
    ...
    const bannerPath = 'C:\\Users\\hecto\\.gemini\\antigravity\\brain\\1c2fd88a-fd50-455c-9041-7be61d1bc324\\sesion_vieja_banner.png';
    ...
    await page.goto('https://rimec-web.vercel.app/carrito');
    await page.waitForTimeout(3000); // Wait for prices validation

    // Take screenshot of cart with blocked CONFIRMAR PEDIDO button
    const cartPath = 'C:\\Users\\hecto\\.gemini\\antigravity\\brain\\1c2fd88a-fd50-455c-9041-7be61d1bc324\\carrito_huerfano_bloqueo.png';
    ...
    try {
      await page.screenshot({ path: 'C:\\Users\\hecto\\.gemini\\antigravity\\brain\\1c2fd88a-fd50-455c-9041-7be61d1bc324\\error_screenshot.png' });
