/** Esquina superior izquierda imagen — descuentos PE (LPC03 10% + comercial dictado; PROMO sin 10%). */
...
export function PeDescComercialBadge({
  ...
  /** Cadena/caso PROMOCIONAL — no mostrar ni aplicar Grado 1 LP03 (+10 %). */
  ...
  const esLpc03 = listaPrecioId === 3 && !esPromocional
  ...
  if (!hayDescuentoPeCatalogo(listaPrecioId, dictado > 0 ? dictado : null, esPromocional)) {
    ...
    <span
      ...
      title={
        ...
        esLpc03
          ...
          ? 'LPC03: 10% fijo + descuento comercial PE'

          : esPromocional

            ? 'PROMOCIONAL: solo descuento comercial (sin +10% LPC03)'

            : 'Descuento comercial PE'
